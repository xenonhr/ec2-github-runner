...
| `associate-public-ip`                                                                                                                                                          | Optional. Defaults to `false`.           | Determines whether a public IP address will be associated with the Github runner's EC2 instance's network interface.                                                                                                                          |
